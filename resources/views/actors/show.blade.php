<x-app-layout>
    ...
    <div style="padding-top: 50px; ">
            ...
            <div class="card">
                ...
                <div class="card_right auth {{ session('nightmode') ? 'active' : '' }}">
                    ...
                    <div class="card_right__details">
                        ...
                        <div class="card_right__social">

                            @if ($social['facebook'])
                                <a href="{{ $social['facebook'] }}" title="Twitter">
                                    <svg style="color: rgb(7, 130, 192); " width="25px" height="25px"
                            ...
                            @endif
                            @if ($social['instagram'])
                                <a href="{{ $social['instagram'] }}" title="Twitter">
                                    <svg style="color: rgb(149, 18, 4);" width="25px" height="25px"
                                        xmlns="http://www.w3.org/2000/svg"
                            ...
                            @if ($social['twitter'])
                                <a href="{{ $social['twitter'] }}" title="Twitter">
                                    ...
                                    <svg style="color: rgb(130, 214, 242);" width="25px" height="25px"
                                        xmlns="http://www.w3.org/2000/svg"
        ...
        <div style="text-align: center; margin-top: 50px">
            <h2 class=" auth {{ session('nightmode') ? 'active' : '' }}">FILMOGRAPHY</h2>
