        ...
        <div class="content-container">
         ...
         <div id="exampleSlider1" style="position: relative;  overflow:hidden;">
                <div class=" MS-content" style="  white-space: nowrap;  overflow:hidden; ">
                    ...
                    @foreach ($up_coming as $movie)
                        ...
                        <div class="featured-content item"
                            ...
                            <img class="featured-title" src="https://image.tmdb.org/t/p/w500//qU4aOZp1fSp22ZG1wj8bnDU2ClJ.png" alt="">
                             {{-- <h1 class="featured-title"> {{ $movie['title'] }}</h1> --}}
                            <p class="featured-desc">    {{ $movie['overview'] }}</p>
                            <a href="{{ route('movie.show', $movie['id']) }}"  class="featured-button">WATCH</a>
                        </div>
            ...
            <div class="movie-list-container" style="margin-top: 20px;">
                ...
                <div class="movie-list-wrapper" id="exampleSlider">
            ...
            <div class="movie-list-container" >
                <h1 class="movie-list-title">TRENDING SHOWS </h1>
