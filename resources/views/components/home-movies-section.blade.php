    ...
    <div class="movie-list-container-trending">
        ...
        <div class="movie-list-wrapper" id="trending">
            ...
            <div class="owl-carousel__nav">
                <button class="owl-carousel__prev"><i class="fa fa-chevron-left" aria-hidden="true"></i></button>
                <button class="owl-carousel__next"><i class="fa fa-chevron-right" aria-hidden="true"></i></button>
            </div>
        </div>
