...
class PopularMovies extends Component
{
    ...
    public function render()
    {
        ...
        $cachedData = (Cache::get('movies-popular'))
        ...
        $popular = (collect($cachedData))
            ->map(function ($cachedData) {
                ...
                ])->put('slug',  Str::of($cachedData['title'])->slug('-')->value)->put('year', Carbon::parse($cachedData['release_date'])->format('Y'));
        ...
        return view('livewire.movies.popular-movies', ['popular' => $popular]);
    }
}
